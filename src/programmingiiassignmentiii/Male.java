...
public class Male extends HumanBeing {
    ...
    public Male(String name, int age,  int weight, int height) throws notHumanBeingException{
        super(name, age);
    ...
    public int getIntLevel(){
        ...
        else if(this.getWeight() >= 120 && this.getWeight() < 149 && this.getHeight() > 70){
            intLevel = 4;
        }
        else if(this.getWeight() >= 50 && this.getWeight() < 119){
            intLevel = 3;
        }
        else if(this.getWeight() >= 120 && this.getWeight() < 149 && this.getHeight() >= 55 && 
                this.getHeight() <= 69){
            intLevel= 2;
        }
        else{intLevel = 3;}
    ...
    public String toString(){
        String output = "Name: " + super.getName() + " Age: " + super.getAge() + " Weight: " + this.getWeight()+ " Height: " + 
