...
public class ProgrammingIIAssignmentIII {

    public static void main(String[] args) throws notHumanBeingException, FileNotFoundException, IOException{
